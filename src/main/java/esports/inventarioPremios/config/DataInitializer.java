...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (premioRepository.count() == 0) {
            log.info(">>> DataInitializer: Base de datos de premios vacía. Insertando inventario inicial...");

            Premio premio1 = new Premio(null, "Efectivo", "Premio al primer lugar del torneo de Valorant", 10000, true);
